...
import stroom.proxy.util.AbstractCommandLineTool;

/**
 * Usage java stroom.proxy.util.config.Configure <parameter file> <files to
 * process>
 */
public class Configure extends AbstractCommandLineTool {
    ...
    public static void printUsage() {
        System.out.println(
                "java stroom.proxy.util.config.Configure parameterFile=<parameter file> processFile=<comma delimited files to process>");
    }
