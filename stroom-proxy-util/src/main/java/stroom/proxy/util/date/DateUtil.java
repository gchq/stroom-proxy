package stroom.proxy.util.date;
...
public final class DateUtil {
    ...
    public static long parseDate(final String pattern, final String timeZoneId, final String value) {
        ...
        final java.time.format.DateTimeFormatter dateFormat = java.time.format.DateTimeFormatter.ofPattern(pattern);
        try {
    ...
    private static ZonedDateTime parse(final java.time.format.DateTimeFormatter formatter, final String value, final ZoneId zoneId) {
